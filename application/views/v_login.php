                ...
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php }elseif ($this->session->flashdata('status')=='danger') {?>
                            <p><h3><?php echo $this->session->flashdata('message'); ?></h3></p>
                        <?php } ?>
                        <form role="form" name="login" action ="<?=site_url('Peserta/auth'); ?>" method="post">
                            <fieldset>
                        ...
                        <a style="text-decoration: underline;" href="<?php echo base_url().'Peserta/forgot';?>"> Lupa Password</a>
                        <div class="clear"></div>
