        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <p>
                        Kegiatan Seniman Mengajar adalah upaya menciptakan ruang-ruang dialog, kolaborasi, dan partisipasi antara seniman dan masyarakat (komunitas seni/komunitas kemasyarakatan) untuk berinteraksi, bertukar informasi, pengetahuan, berkarya, serta membangun jejaring bagi beberpa tujuan berikut:
<ul>
   <li> 1.  Mendukung proses penciptaan karya artistik dan ekspresi budaya</li>
<li> 2.  Mendukung berkembangnya wisata-budaya</li>
<li> 3.  Mendukung perkembangan ekonomi kreatif berbasis potensi daerah dan kearifan lokal</li>
</ul>
                    ...
                    <p>
                        <h4>TARGET KEGIATAN SENIMAN MENGAJAR</h4>
                        <ul>
                            <li>
                                1.  Memberikan kesempatan bagi seniman untuk mengembangkan ide dan eksplorasi potensi kreativitas karya seni dan budaya
                            </li>
                            <li>
                                2.  Menggali potensi daerah melalui pemetaan bentuk-bentuk kesenian dan ekspresi budaya yang mengakar dan berkembang di wilayah setempat
                            </li>
                            <li>
                                3.  Menciptakan nilai, makna, karakter, dan identitas yang terkait dengan potensi seni budaya setempat
                            </li>
                            <li>
                                4.  Mendorong kreativitas berkesenian 
                            </li>
                            <li>
                                5.  Meningkatkan kesadaran masyarakat untuk mengapresiasi seni
                            </li>
                            <li>
                                6.  Mendorong masyarakat untuk melakukan proses dokumentasi, konservasi dan preservasi bentuk kesenian daerah
                            </li>
                            <li>
                                7.  Mendekatkan masyarakat dengan kegiatan kesenian     
                            </li>
                            <li>
                                8.  Membangun jejaring antar seniman
                            </li>
                        </ul>
                    </p>
                    <p>
                        <h4>INDIKATOR CAPAIAN KEGIATAN SENIMAN MENGAJAR</h4>
                        <ul>
                            <li>
                                1.  Munculnya upaya revitalisasi kesenian dan ekspresi budaya setempat
                            </li>
                            <li>
                            ...
                            <li>
                                4.  Terbentuknya ketertarikan masyarakat dalam memanfaatkan seni baik secara kultural ataupun komersial
                            </li>
                            <li>
                                5.  Terciptanya jejaring dan kerjasama secara profesional dalam penciptaan karya seni 
                            </li>
                            <li>
                                6.  Tumbuhnya event seni budaya di masyarakat setempat
                            </li>
                            <li>
                                7.  Terdokumentasinya dengan baik kegiatan seni budaya setempat
                            </li>
                        </ul>
                    </p>
                    <p>
                        <h4>PELAKSANAAN SENIMAN MENGAJAR</h4>
